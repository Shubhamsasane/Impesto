...
<%
	...
	try
	{
		...
		PreparedStatement ps=conn.prepareStatement("select likecomment from comment where cmtId='"+cmtId+"'");
		...
		String req="update comment set likecomment="+count+" where cmtId='"+cmtId+"'";
