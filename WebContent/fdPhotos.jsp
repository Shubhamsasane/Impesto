...
<%!
	String fname,lname,fdEmail,email,time,fdEm;
java.util.Date date;
%>
<%
	if(session!=null)
	...
	<div class="container-fluid text-center" >
		<div class="row" >
						...
						try
						{
							...
							PreparedStatement ps=conn.prepareStatement("select time from timeline where email='"+currentFriend+"' order by time asc");
							...
							while(rs.next())
							{
								...
								out.print("<div class='col-sm-2'>");
									out.print("<div class='thumbnail' style='height:185px;width:185px;'>");
										out.println("<img  src='postRetrieve.jsp?email="+currentFriend+"&time="+time+"' alt='friend' style='height:100%;' >");
