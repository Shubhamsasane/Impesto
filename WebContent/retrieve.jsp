...
<%
	...
	if(session!=null)
		{  
        	...
        	System.out.println("_____________________________"+email);
    	}  
	else
		{  
...
try{
	...
	System.out.println("CONNECTED product");
 	 ...
 	 PreparedStatement ps = conn.prepareStatement("select dp from profile_pic where email=?");
